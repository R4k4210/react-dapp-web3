...
var Web3ContextProvider = function (_a) {
    ...
    var _b = react.useReducer(web3Reducer, initialState), state = _b[0], dispatch = _b[1];
    return jsxRuntime.jsx(Web3Context.Provider, __assign({ value: { state: state, dispatch: dispatch } }, { children: children }), void 0);
};
...
var useWeb3 = function () {
    var _a = react.useContext(Web3Context), state = _a.state, dispatch = _a.dispatch;
    var walletAddress = state.walletAddress, web3 = state.web3, signature = state.signature;
    var _b = react.useState(false), isWalletConnected = _b[0], setIsWalletConnected = _b[1];
                ...
                switch (_c.label) {
                    case 0:
                        try {
                            ...
                            if (signatureStorage !== "") {
                                dispatchAction(exports.EActionTypes.SIGN_MESSAGE, web3, walletAddress, signatureStorage);
                            }
                        }
                        catch (error) {
    ...
    var disconnect = function () {
        ...
        dispatchAction(exports.EActionTypes.DISCONNECT, null, "", "");
    };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    dispatchAction(exports.EActionTypes.CONNECT, web3, walletAddress, "");
                    return [2 /*return*/];
            }
        });
    }); };
    var instanceWalletConnect = function (justChecking) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = new WalletConnectProvider__default['default']({
                ...
                case 6:
                    walletAddress = _a.sent();
                    dispatchAction(exports.EActionTypes.CONNECT, web3, walletAddress, signature);
                    return [2 /*return*/];
            }
        });
    }); };
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    dispatchAction(exports.EActionTypes.SIGN_MESSAGE, web3, walletAddress, newSignature);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        dispatchAction(exports.EActionTypes.WALLET_CHANGED, web3, newWalletAddress, signature);
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    var setupWeb3 = function (provider) {
        return new Web3__default['default'](provider);
    };
...
var withWeb3 = function (WrappedComponent) {
    return function (props) {
        ...
        return (jsxRuntime.jsx(WrappedComponent, __assign({}, props, { web3Data: {
                isWalletConnected: isWalletConnected,
                walletAddress: walletAddress,
                signature: signature,
                web3: web3,
